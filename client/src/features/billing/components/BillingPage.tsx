  ...
  const plans = [
    {
      ...
      features: [
        "Limited daily search queries",
        "Limited daily quick chats",
        "Limited active recall card creation",
        "Limited interactive canvas visualizations",
        "Limited document uploads & size (5MB)",
        "Limited image uploads & size (2MB)",
        "Limited agent workspaces",
        "Standard models (Gemini Flash) with limited tokens",
      ],
      cta: "Default",
    },
    {
      ...
      features: [
        "10x more daily search queries",
        "Extra daily quick chats",
        "Extra active recall card creation",
        "Extra interactive canvas visualizations",
        "Extra document uploads & capacity (20MB)",
        "Extra image uploads & capacity (10MB)",
        "Extra agent workspaces",
        "Access to premium models (GPT-5, Claude) with extra token limits",
      ],
      cta: "Upgrade to Pro",
      popular: true,
    },
    {
      ...
      features: [
        ...
        "Unlimited quick chats",
        "Unlimited active recall card creation",
        "Unlimited interactive canvas visualizations",
        "Unlimited document uploads & size (100MB)",
        "Unlimited image uploads & size (50MB)",
        "Unlimited agent workspaces",
        "Connect custom Gemini, OpenAI, & Anthropic keys (zero platform caps)",
      ],
      cta: "Configure Key",
    },
    {
      ...
      features: [
        "Vastly extended daily search queries",
        "Vastly extended daily quick chats",
        "Vastly extended active recall card creation",
        "Vastly extended canvas visualizations",
        "Huge document uploads & size (100MB)",
        "Huge image uploads & size (50MB)",
        "Vastly extended agent workspaces",
        "Maximized token limits for premium models",
      ],
      cta: "Contact Sales",
    },
  ];
