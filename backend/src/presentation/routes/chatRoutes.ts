...
router.post('/:id/upload-file', userProtect, (req, res, next) => chatController.uploadChatPdf(req, res).catch(next));
router.post('/:id/upload-pdf', userProtect, (req, res, next) => chatController.uploadChatPdf(req, res).catch(next));
