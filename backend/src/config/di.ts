...
import { MongoDeckRepository } from "../infrastructure/recall/repositories/MongoDeckRepository";
import { CreateDeck } from "../application/deck/use-cases/CreateDeck";
import { GetDecks } from "../application/deck/use-cases/GetDecks";
import { UpdateDeck } from "../application/deck/use-cases/UpdateDeck";
import { DeleteDeck } from "../application/deck/use-cases/DeleteDeck";
import { MoveCardToDeck } from "../application/deck/use-cases/MoveCardToDeck";
import { MoveCardsToDeck } from "../application/deck/use-cases/MoveCardsToDeck";
import { GetDeckStats } from "../application/deck/use-cases/GetDeckStats";
...
container.registerSingleton("IDeckRepository", MongoDeckRepository);
container.registerSingleton("ICreateDeckUseCase", CreateDeck);
container.registerSingleton("IGetDecksUseCase", GetDecks);
container.registerSingleton("IUpdateDeckUseCase", UpdateDeck);
container.registerSingleton("IDeleteDeckUseCase", DeleteDeck);
container.registerSingleton("IMoveCardToDeckUseCase", MoveCardToDeck);
container.registerSingleton("IMoveCardsToDeckUseCase", MoveCardsToDeck);
container.registerSingleton("IGetDeckStatsUseCase", GetDeckStats);
